...
def generate_launch_description():
    ...
    def run_yolo(context: LaunchContext, use_tracking, use_3d):
        ...
        model_cmd = DeclareLaunchArgument(
            "model",
            default_value=os.path.join(get_package_share_directory("yolo_bringup"), "models", "yolov8n-seg_5.pt"),
            # default_value=os.path.join(get_package_share_directory("yolo_bringup"), "models", YOLO('yolov8n-seg.pt')),

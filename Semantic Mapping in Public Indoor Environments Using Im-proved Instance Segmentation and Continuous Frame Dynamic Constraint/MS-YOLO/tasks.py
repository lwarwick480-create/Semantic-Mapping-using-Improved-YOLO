...
from ultralytics.nn.backbone.mobilenetv4 import  mobilenetv4_small, mobilenetv4_medium, mobilenetv4_large, mobilenetv4_hybrid_medium, mobilenetv4_hybrid_large
import torch
from ultralytics.nn.C2f.C2f_SHViTBlock import C2f_SHViTBlock
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        elif m in {mobilenetv4_small, mobilenetv4_medium, mobilenetv4_large, mobilenetv4_hybrid_medium, mobilenetv4_hybrid_large}:
            m = m(*args)
            c2 = m.channels
